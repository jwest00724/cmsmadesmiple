...
#
#$Id: CMSUpgradePage2.class.php 296 2010-10-17 22:31:18Z calguy1000 $
...
class CMSInstallerPage2 extends CMSInstallerPage
{
	...
	{
	  $this->CMSInstallerPage($installer, $number, $smarty, $errors, $debug);
	...
	function assignVariables()
	{
		...
		$settings['required'][] = testBoolean(0, ilang('test_check_register_globals'), 'register_globals', ilang('test_check_register_globals_failed'), true, true, 'register_globals_enabled');
