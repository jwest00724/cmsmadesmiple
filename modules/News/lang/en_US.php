...
<li>&quot;fesubmit&quot; - <strong>Deprecated</strong> to display the frontend form for allowing users to submit news articles on the front end. Enable this function in the Options tab in the News module admin page. Add the <code>{cms_init_editor}</code> tag in the metadata section to initialize the selected front end WYSIWYG editor. (Site Admin >> Global Settings).</li>
<li>&quot;browsecat&quot; - to display a browseable category list.</li>
</ul>
EOT;
$lang['help'] = <<<EOF
<h3>Important Notes</h3>
<p>Version 2.15 - Front End action needs to be enabled in the options tab of the News module after upgrade!</p>
