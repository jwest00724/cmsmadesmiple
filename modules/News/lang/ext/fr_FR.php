<?php
$lang['warn_fesubmit_deprecated'] = 'Cette fonctionnalité de soumission via le Frontend est officiellement obsolète. Merci de trouver une autre solution pour cette fonctionnalité.';
$lang['fesubmit_allowed'] = 'Autoriser les soumission des articles via le Frontend&nbsp;';
...
$lang['title_fesubmit_settings'] = 'Paramètres de soumission via le Frontend  (site Web)';
...
<li>"fesubmit" - <strong>Obsolète</strong> pour afficher le gabarit de soumission (frontend) d\'articles des utilisateurs dans les pages du site. Activez cette fonction dans l\'onglet options de la page du module Articles (News). Ajouter le <code>{cms_init_editor}</code> dans la section des méta-données pour initialiser l\'éditeur WYSIWYG sélectionné (Administration du site/Paramètres globaux/WYSIWYG de la partie publique).</li>
<li>"browsecat" - pour afficher une liste de catégories.</li>
</ul>';
$lang['help'] = '<h3>Notes Importantes</h3>
<p>Version 2.15 - Cette fonction de soumission via le site Web (Frontend) doit être activée dans l\'onglet options de la page du module Articles (News) après mise à jour !</p>
