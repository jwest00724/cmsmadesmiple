...
$lang['info_expired_viewable'] = 'Wenn aktiviert, k&ouml;nnen abgelaufene Artikel im Detail-Modus angezeigt werden (dies reproduziert alte Funktionalit&auml;t). Der showall Parameter kann f&uuml;r die URL (wenn sie pretty URL&#039;s nicht verwenden) verwendet werden, um zu zeigen dass auch abgelaufene Artikel angezeigt werden k&ouml;nnen.';
$lang['expired_viewable'] = 'Abgelaufene Artikel k&ouml;nnen in der Detailansicht angezeigt werden';
...
$lang['warning_preview'] = 'Warnung: Diese Vorschau verh&auml;lt sich &auml;hnlich wie ein Browser-Fenster, mit dem Sie von der urspr&uuml;nglich ausgew&auml;hlten Seite aus navigieren k&ouml;nnen. Jedoch k&ouml;nnen unerwartete Verhalten auftreten. Wenn Sie auf der urspr&uuml;nglich angew&auml;hlten Seite navigieren und dann dorthin zur&uuml;ckkehren, sehen Sie die unver&auml;nderten Inhalte, obwohl Sie im der Hauptregisterkarte &Auml;nderungen vorgenommen und diese neu geladen haben. Wenn Sie Inhalte hinzuf&uuml;gen, w&auml;hrenddessen Sie auf der Seite navigieren, ist es Ihnen nicht m&ouml;glich zur&uuml;ckzukehren - Sie m&uuml;ssen dann die Vorschau-Seite aktualisieren.<br /><strong>Hinweis:</strong> Im Vorschau-Modus werden keine Dateien hochladen, die Sie m&ouml;glicherweise daf&uuml;r ausgew&auml;hlt haben.';
$lang['article'] = 'Artikel';
$lang['preview'] = 'Vorschau';
$lang['info_detail_returnid'] = 'Mit diesen Einstellungen kann eine Seite festgelegt werden (und damit auch ein Template), die f&uuml;r die Anzeige der Detailansicht verwendet werden soll. Die individuellen News-Detail-URLs werden jedoch nicht funktionieren, wenn dieser Parameter keine g&uuml;ltige Seite enth&auml;lt. Wird diese Einstellung aktiviert und im news-Tag der Parameter detailpage nicht angegeben, wird dieser Wert f&uuml;r Detail-Links verwendet.';
$lang['title_detail_returnid'] = 'Voreingestellte Seite, die f&uuml;r die Detailansicht verwendet werden soll';
$lang['title_submission_settings'] = 'Einstellungen f&uuml;r die News-&Uuml;bertragung';
$lang['title_fesubmit_settings'] = 'Einstellungen f&uuml;r die News-Einsendung &uuml;ber die Webseite';
$lang['title_notification_settings'] = 'Benachrichtigungseinstellungen';
$lang['title_detail_settings'] = 'Einstellungen f&uuml;r die Detailansicht';
$lang['error_invalidurl'] = 'Ung&uuml;ltige URL <em>(eventuell wird diese bereits verwendet oder sie enth&auml;lt ung&uuml;ltige Zeichen)</em>';
$lang['url'] = 'Individuelle Artikel-URL';
$lang['expired_searchable'] = 'Artikel, deren Anzeigedauer &uuml;berschritten ist, d&uuml;rfen in den Suchergebnissen erscheinen';
$lang['helpshowall'] = 'Mit diesem Parameter k&ouml;nnen alle Artikel (unabh&auml;ngig von der festgelegten Anzeigedauer) angezeigt werden (showall=&#039;1&#039;).';
$lang['error_invaliddates'] = 'Ein oder mehrere der eingegebenen Daten sind ung&uuml;ltig';
$lang['notify_n_draft_items_sub'] = '%d News-Artikel';
$lang['notify_n_draft_items'] = '%s News-Artikel wurde(n) noch nicht ver&ouml;ffentlicht.';
$lang['unlimited'] = 'Unbegrenzt';
$lang['none'] = 'Keine';
$lang['anonymous'] = 'Anonym';
$lang['unknown'] = 'Unbekannt';
$lang['fesubmit_redirect'] = 'Die Seiten-ID oder der Seiten-Alias der Seite, auf die der Einsender eines Artikels &uuml;ber die fesubmit-Aktion weitergeleitet werden soll';
...
$lang['browsecattemplate'] = 'Templates f&uuml;r die Kategorien-Anzeige';
...
$lang['fesubmit_status'] = 'Status f&uuml;r Artikel, die &uuml;ber die Webseite (Frontend) eingesandt wurden';
...
$lang['msg_contenttype_removed'] = 'Der Inhaltstyp &bdquo;News&ldquo; wird nicht mehr unterst&uuml;tzt. Bitte verwenden Sie in Ihren Seiten-Templates bzw. -inhalten anstatt dessen den {news}-Tag mit den entsprechenden Parametern.';
$lang['delete_selected'] = 'Ausgew&auml;hlte Artikel l&ouml;schen';
$lang['areyousure_deletemultiple'] = 'Wollen Sie wirklich alle ausgew&auml;hlten Artikel l&ouml;schen?\nDies kann NICHT r&uuml;ckg&auml;ngig gemacht werden!';
$lang['error_templatenamexists'] = 'Es existiert bereits ein Template mit diesem Namen!';
$lang['error_noarticlesselected'] = 'Es wurden keine Artikel ausgew&auml;hlt';
...
$lang['hide_summary_field'] = 'Das Zusammenfassungsfeld verbergen, wenn ein Artikel hinzugef&uuml;gt oder bearbeitet wird';
...
$lang['allowed_upload_types'] = 'Es d&uuml;rfen nur Dateien mit dieser Namenserweiterung hochgeladen werden';
$lang['fielddefupdated'] = 'Das Extra-Feld wurde aktualisiert';
$lang['editfielddef'] = 'Extra-Feld bearbeiten';
$lang['up'] = 'Nach oben';
$lang['down'] = 'Nach unten';
$lang['fielddefdeleted'] = 'Extra-Feld gel&ouml;scht';
$lang['nameexists'] = 'Ein Extra-Feld mit diesem Namen existiert bereits';
$lang['notanumber'] = 'Die maximale L&auml;nge ist keine Zahl';
$lang['fielddef'] = 'Extra-Feld';
$lang['fielddefadded'] = 'Das Extra-Feld wurde hinzugef&uuml;gt';
...
$lang['addfielddef'] = 'Extra-Feld hinzuf&uuml;gen';
$lang['customfields'] = 'Extra-Felder';
$lang['deprecated'] = 'Nicht unterst&uuml;tzt';
$lang['subject_newnews'] = 'Es wurde ein neuer Artikel eingesandt';
$lang['email_subject'] = 'Betreff der ausgehenden Email';
$lang['email_template'] = 'Inhalt der Email-Nachricht';
$lang['formsubmit_emailaddress'] = 'Email-Adresse zur Benachrichtigung bei neuen Artikeln';
$lang['extra'] = 'Extra-Feld';
...
$lang['title_form_template'] = 'Editor f&uuml;r die Formular-Templates';
$lang['title_detail_template'] = 'Editor f&uuml;r die Detail-Templates';
$lang['title_summary_template'] = 'Editor f&uuml;r die Zusammenfassungs-Templates';
$lang['prompt_templatename'] = 'Template-Name';
$lang['prompt_template'] = 'Template-Quelle';
$lang['title_form_sysdefault'] = 'Voreingestelltes Template f&uuml;r das Formular';
$lang['title_summary_sysdefault'] = 'Voreingestelltes Template f&uuml;r die Zusammenfassung';
$lang['title_detail_sysdefault'] = 'Voreingestelltes Template f&uuml;r die Details';
$lang['info_sysdefault2'] = '<strong>Hinweis:</strong> In den Textbereichen dieser Registerkarte k&ouml;nnen Sie die Templates vordefinieren, die automatisch eingef&uuml;gt werden, wenn Sie eine neues Zusammenfassungs-, Detail- oder Formular-Template erstellen. Das &Auml;ndern/Speichern der Inhalte in diesem Reiter hat <strong>keine Auswirkungen auf die aktuelle Anzeige</strong>.';
$lang['info_sysdefault'] = '(der Inhalt, der standardm&auml;&szlig;ig beim Erstellen eines neuen Templates verwendet wird)';
...
$lang['articleadded'] = 'Der Artikel wurde hinzugef&uuml;gt.';
$lang['articleupdated'] = 'Der Artikel wurde aktualisiert.';
$lang['articledeleted'] = 'Der Artikel wurde gel&ouml;scht.';
$lang['addcategory'] = 'Kategorie hinzuf&uuml;gen';
$lang['categoryadded'] = 'Die Kategorie wurde hinzugef&uuml;gt.';
...
$lang['content'] = 'Inhalt';
$lang['dateformat'] = '%s ist nicht im g&uuml;ltigen Format &bdquo;JJJJ-MM-TT hh:mm:ss&ldquo;';
$lang['delete'] = 'L&ouml;schen';
$lang['description'] = 'Hinzuf&uuml;gen, Bearbeiten und L&ouml;schen von News-Artikeln';
$lang['formtemplate'] = 'Formular-Templates';
...
$lang['enddate'] = 'Ende';
$lang['endrequiresstart'] = 'Wenn Sie einen Endzeitpunkt angeben, m&uuml;ssen Sie auch ein Startzeitpunkt festgelegen.';
$lang['entries'] = '%s Eintr&auml;ge';
$lang['status'] = 'Status';
$lang['expiry'] = 'Ablauf';
$lang['filter'] = 'Artikel-Filter';
$lang['more'] = 'weiterlesen';
$lang['category_label'] = 'Kategorie:';
$lang['author_label'] = 'Erstellt von:';
$lang['extra_label'] = 'Extra';
$lang['moretext'] = 'Text f&uuml;r den Link &bdquo;weiterlesen&ldquo;';
$lang['name'] = 'Name';
$lang['news'] = 'News';
...
$lang['nocontentgiven'] = 'Fehler: Es wurde kein Inhalt eingegeben';
$lang['noitemsfound'] = '<strong>Keine</strong> Eintr&auml;ge in der Kategorie %s gefunden';
$lang['nopostdategiven'] = 'Fehler: Es wurde kein Erstellungsdatum eingestellt';
...
$lang['postinstall'] = 'Stellen Sie sicher, dass die Benutzer, die die News verwalten, die Berechtigung &bdquo;Modify News&ldquo; haben.';
...
$lang['summarytemplate'] = 'Zusammenfassungs-Templates';
$lang['summarytemplateupdated'] = 'Das Zusammenfassungs-Template wurde aktualisiert.';
$lang['title'] = 'Titel';
...
<table>
	...
	<tbody>
		<tr>
			<th>news_id</th>
			<td>ID des News-Artikels</td>
		</tr>
		<tr>
			<th>category_id</th>
			<td>ID der Kategorie f&uuml;r diesen Artikel</td>
		</tr>
		<tr>
			<th>title</th>
		...
		<tr>
			<th>status</th>
			<td>Status des Artikels (&bdquo;Entwurf/draft&ldquo; oder &bdquo;Ver&ouml;ffentlicht/publish&ldquo;)</td>
		</tr>
		<tr>
			<th>start_time</th>
...
$lang['helpmoretext'] = 'Mit diesem Parameter wird der Text festgelegt, der nach der News-Zusammenfassung angezeigt wird, wenn der Artikel l&auml;nger als die vorgegebene L&auml;nge ist. Vorgegeben ist &bdquo;Weiterlesen &hellip;&ldquo;';
$lang['helpsummarytemplate'] = 'Verwendet ein separates Template f&uuml;r die Anzeige der Artikel-Zusammenfassungen. Dieses Template muss vorhanden sein und in der Administration des News-Moduls in der Registerkarte &bdquo;Zusammenfassungs-Template&ldquo; angezeigt werden. Ohne Parameter wird das als Standard gekennzeichnete Template verwendet.';
$lang['helpformtemplate'] = 'Verwendet ein Template f&uuml;r die Anzeige des Formulars zur &Uuml;bermittlung neuer Artikel. Dieses Template muss vorhanden sein und in der Administration des News-Moduls in der Registerkarte &bdquo;Formular-Template&ldquo; angezeigt werden. Ohne Parameter wird das als Standard gekennzeichnete Template verwendet.';
$lang['helpbrowsecattemplate'] = 'Verwendet ein Template f&uuml;r die Anzeige der Kategorien. Dieses Template muss vorhanden sein und  in der Administration des News-Moduls in der Registerkarte &bdquo;Kategorien-Template&ldquo; angezeigt werden. Sie muss jedoch nicht als Standard gekennzeichnet sein. Ohne Parameter wird das als Standard gekennzeichnete Template f&uuml;r die Anzeige verwendet.';
$lang['helpdetailtemplate'] = 'Verwendet eine separates Template f&uuml;r die Detail-Anzeige des Artikels. Dieses Template muss vorhanden sein und in der Administration des News-Moduls in der Registerkarte &bdquo;Detail-Template&ldquo; angezeigt werden. Ohne Parameter wird das als Standard gekennzeichnete Template verwendet.';
$lang['helpsortby'] = 'Felder, nach denen die Eintr&auml;ge sortiert werden. M&ouml;gliche Optionen sind: &bdquo;news_date&ldquo;, &bdquo;summary&ldquo;, &bdquo;news_data&ldquo;, &bdquo;news_category&ldquo;, &bdquo;news_title&ldquo;, &bdquo;news_extra&ldquo;, &bdquo;end_time&ldquo;, &bdquo;start_time&ldquo;, &bdquo;random&ldquo;. Standard ist &bdquo;news_date&ldquo;. Ist die gew&auml;hlte Option &bdquo;random&ldquo;, wird der Parameter &bdquo;sortasc&ldquo; ignoriert.';
...
<li>&quot;fesubmit&quot; - auf der Webseite ein Formular zum Einsenden neuer Artikel anzeigen. Um f&uuml;r das Formular den voreingestellten WYSIWYG-Editor zu verwenden, m&uuml;ssen Sie den Metadaten (Webseiten-Administration > Globale Einstellungen) <code>{cms_init_editor}</code> hinzuf&uuml;gen.</li>
...
<p>Am einfachsten kann das Modul mit dem <code>{news}</code>-Tag verwendet werden. Dieser f&uuml;gt die Ausgabe des Moduls in Ihr Template oder Seite ein und zeigt die News-Eintr&auml;ge an. Der einzuf&uuml;gende Code sollte so aussehen: <code>{news number=&#039;5&#039;}</code></p>
<h3>Templates</h3>
<p>Seit Version 2.3 werden die Templates des News-Moduls in der Datenbank gespeichert. Dateibasierte Templates werden nicht mehr unterst&uuml;tzt. Wenn Sie noch solche verwenden, sollten Sie mit der folgenden Anleitung jedes verwendete (dateibasierte) Template importieren:</p>
<ul>
<li>Kopieren Sie den Inhalt Ihrer Template-Datei in den Zwischenspeicher Ihres Rechners.</li>
<li>Erstellen Sie ein neues Datenbank-Template <em>(je nach Bedarf f&uuml;r die Zusammenfassungs- oder Detailansicht)</em>. Geben Sie dem neuen Template den gleichen Namen wie der alten (einschlie&szlig;lich der Endung .tpl). F&uuml;gen Sie den Inhalt des Zwischenspeichers ein.</li>
...
<p>Auch die Variablen der Extra-Felder k&ouml;nnen in den Templates separat verwendet werden. So l&auml;sst sich zum Beispiel das Extrafeld mit dem Namen &bdquo;musterfeld&ldquo; &uuml;ber die Variable entry->musterfeld abfragen.</p>
<p><strong>ACHTUNG:</strong> Leerzeichen m&uuml;ssen dabei durch den Unterstrich (&bdquo;_&ldquo;) ersetzt werden.</p>';
