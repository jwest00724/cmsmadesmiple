...
<ul>
  ...
  <li>Ajouter la balise {cms_init_editor} pour les pages où l\'éditeur WYSIWYG sera utilisé. Cela peut être fait soit dans la section head du gabarit de la page, soit dans les "Métadonnées globales", ou dans "Métadonnées spécifiques pour cette page". Cette balise ne prend pas de paramètres supplémentaires.</li>
</ul>';
