...
#
#$Id: listtemplates.php 9874 2015-03-28 21:17:37Z JoMorg $
			...
			if ($counter < $page*$limit && $counter >= ($page*$limit)-$limit) {
				...
				if ($all) {
				  ...
				  if( $onetemplate->active == 1 ) {
				    echo "<a href=\"listtemplates.php".$urlext."&amp;action=setallcontent&amp;template_id=".$onetemplate->id."\" onclick=\"return confirm('".cms_html_entity_decode(lang('setallcontentconfirm') )."');\">".lang('setallcontent')."</a>";
				  }
				  echo "</td>\n";
				}
