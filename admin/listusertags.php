...
#
#$Id: listusertags.php 9874 2015-03-28 21:17:37Z JoMorg $
...
if( count($tags) )
  {
	...
	echo "</a></td>\n";
	echo "<td class=\"icons_wide\"><a href=\"deleteuserplugin.php".$urlext."&amp;userplugin_id=".$oneplugin."\" onclick=\"return confirm('".cms_html_entity_decode(lang('deleteconfirm', $oneplugin) )."');\">";
